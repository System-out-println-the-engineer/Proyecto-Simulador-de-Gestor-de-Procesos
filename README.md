...
![Java](https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white) ![Swing](https://img.shields.io/badge/Swing-007396?style=for-the-badge&logo=java&logoColor=white)

![Dashboard del Simulador](capturas/dashboard_general.png)
...
![Gestión de Memoria](capturas/gestion_memoria.png)

* **Algoritmos de Planificación (FCFS, SJF, Prioridades, Round Robin con preemption).**
![Expulsión Round Robin](capturas/round_robin.png)

* **Sincronización IPC (Productor-Consumidor con semáforos).**
![Módulo IPC](capturas/ipc_funcionando.png)
